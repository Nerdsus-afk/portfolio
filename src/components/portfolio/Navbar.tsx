  ...
  return (
    ...
    >
      <nav className="container flex items-center justify-between h-16">
        <a href="#" onClick={(e) => { e.preventDefault(); navigate("/"); setTimeout(() => { window.scrollTo({ top: 0, behavior: "smooth" }); }, 300); }} className="font-display text-xl font-semibold tracking-tight">
